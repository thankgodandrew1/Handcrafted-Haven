        ...
        <div className="header z-0 lg:z-10 lg:fixed w-full md:z-0">
            <nav className="md:flex p-5 md:justify-between w-auto">
                ...
                <span className="text-3xl font-bold">
                    <img width={40} height={40} className="h-12  inline" src="https://cdn-icons-png.flaticon.com/128/3859/3859602.png" alt="logo" />
                    Handcrafted Haven 
                </span>
                </a>
                {isClick ? (
                    <Image  className="menu_class md:hidden" src="https://icon-library.com/images/x-mark-icon/x-mark-icon-21.jpg" 
                    alt="Hamburger menu" 
                    height={40}
                    width={40}
                    ...
                    <Image className="menu_class md:hidden" src="https://icon-library.com/images/hamburger-menu-icon-transparent/hamburger-menu-icon-transparent-23.jpg" 
                    alt="Hamburger menu" 
                    height={40}
                    width={40}
                    onClick={toggleNavBar}
                ...
                md:py-0 py-4 md:pl-0 pl-7 md:opacity-100  top-[-400px] transition-all ease-in duration-500">
                    <li className="mx-4"><a href="/" className="cursor-pointer">Home</a></li>
                    <li className="text-2xm mx-4"><Link href="/seller-profile" className="cursor-pointer">Seller Profiles</Link></li>
                    <li className="mx-4"><Link href="/productListings" className="cursor-pointer">Product Listings</Link></li>
                    <li className="text-green-500 mx-4"><a href="/ReviewsAndRatings" className="cursor-pointer">Reviews and Ratings</a></li>
                    <li>
