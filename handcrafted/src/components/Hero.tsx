    ...
    return (
        <div className="bg-cover hg-100%" style={{ 
            ...
            <div className="grid grid-cols-4 h-full p-8 mb-2 bg-gray-600 mt-4 ml-20" >
                <div className="border-solid border-4 border-text max-w-md mt-16 p-8 mb-64 rounded-2xl col-start-1 col-end-3 row-start-1 row-end-4">
                    <h1 className="font-bold underline">You are Welcome to Handcrafted Haven</h1>
                    <p className="text-text text-opacity-100">Handcrafted Haven is an innovative web application that aims to 
                ...
                <div className="border-secondary bg-opacity-100 max-w-md border-solid border-4 rounded-2xl mt-64 mb-2 p-8 col-start-3 col-end-5 h-auto shadow-2xl opacity-100">
