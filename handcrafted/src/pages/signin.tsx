...
export const siteTitle = 'Login | HandCrafted Haven'
          ...
          <div className="form-block mt-10">
            ...
            >
              <div className="relative mt-3">
                <input
                  className="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600"
                  placeholder="Email"
                  type="text"
                  name="email"
...
/>
              ...
              <button
                type="submit"
                className="text-black py-2 px-4 uppercase rounded bg-indigo-500 hover:bg-indigo-600 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5"
              >
                Sign in
              </button>
