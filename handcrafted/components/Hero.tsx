    ...
    return (
        <div className="bg-cover hg-100%" style={{ 
            ...
            <div className="grid grid-cols-4 h-full p-8 mb-2 bg-gray-600 mt-4 ml-20" >
                ...
                <div className="border-green-500 bg-opacity-100 max-w-md border-solid border-4 rounded-2xl mt-64 mb-2 p-8 col-start-3 col-end-5 h-auto shadow-2xl opacity-100">
